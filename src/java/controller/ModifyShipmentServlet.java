...
public class ModifyShipmentServlet extends HttpServlet {
     ...
     protected void doPost(HttpServletRequest request, HttpServletResponse response)   throws ServletException, IOException {       
             ...
             int shippost = Integer.parseInt(request.getParameter("shippost"));
             String testpost = request.getParameter("shippost");
             ...
             DBManager manager = (DBManager) session.getAttribute ("manager");
                     ...
                     try {          
                            ...
                            if(exist == null){
                                ...
                                manager.updateShipment(shipid,shipname,shipnum,shipadd,shippost,shipcour,shipstat,shipdate,orderid);
                           ...
                           Logger.getLogger(ModifyShipmentServlet.class.getName()).log(Level.SEVERE, null, ex);       
                     }
     }
}
